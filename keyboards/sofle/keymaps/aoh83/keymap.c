...
//   KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
  ...
  MO(_RAISE),   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_BSLS,
  LT(_LOWER,
  KC_ESC),   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  LT(_LOWER, KC_EQUAL),
...
[_LOWER] = LAYOUT(
  ...
  KC_GRV,  KC_EXLM,   KC_AT,  KC_LCBR, KC_RCBR, KC_GRV,                         XXXXXXX, KC_7,    KC_8,    KC_9,    KC_0,  KC_F12,
  _______, KC_HASH,  KC_DLR, KC_LPRN, KC_RPRN, KC_PIPE,                         KC_AMPR, KC_4,    KC_5,    KC_6, KC_PLUS, _______,
  _______, KC_PERC,  KC_CIRC, KC_LBR, KC_RBR,  KC_TILD, _______,       _______, KC_0,    KC_3,    KC_2,    KC_1, KC_BSLS, _______,
