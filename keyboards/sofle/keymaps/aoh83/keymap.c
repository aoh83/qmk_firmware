...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_LOWER]  = {ENCODER_CCW_CW(KC_PLUS, KC_MINUS), ENCODER_CCW_CW(KC_DOWN, KC_UP)},
    [_RAISE]  = {ENCODER_CCW_CW(KC_BRIU, KC_BRID), ENCODER_CCW_CW(KC_RIGHT, KC_LEFT)},
};
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        LT(_LOWER, KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LT(_LOWER, KC_QUOT),
         ...
         KC_LGUI, MT(MOD_LCTL, KC_LEFT), MT(MOD_LALT, KC_RIGHT), KC_TAB, KC_BSPC, KC_ENT, KC_SPC, MT(MOD_RALT, KC_DOWN), MT(MOD_RCTL, KC_UP), KC_RGUI),
    /* LOWER
     * ,-----------------------------------------.                    ,-----------------------------------------.
