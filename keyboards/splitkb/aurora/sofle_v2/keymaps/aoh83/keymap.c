...
#define TL ACTION_TAP_DANCE_LAYER_MOVE

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    KC_GRV,  KC_1, KC_2, KC_3, KC_4, KC_5,                     KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV,
    _______,  KC_Q, KC_W, KC_E, KC_R, KC_T,                     KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
    TL(KC_ESC, 1),  KC_A, KC_S, KC_D, KC_F, KC_G,                     KC_H, KC_J, KC_K, KC_L, KC_SCLN, TL(DKC_QUOT, 1),
  ...
  [1] = LAYOUT(
    ...
    KC_GRV,  S(KC_1), S(KC_2),    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F12,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
       { KC_VOLU, KC_VOLD }, { KC_PGUP, KC_PGDN }
};
